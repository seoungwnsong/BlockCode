...
function pyLiteral(expression: LiteralExpression): string {
...
function pyExpression(expression: Expression): string {
  switch (expression.type) {
    case "literal":
...
function buildPythonSource(functions: UserFunction[], mainBlocks: Block[]) {
